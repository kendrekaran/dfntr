        ...
        <div className="flex items-center justify-between max-w-[1240px] mx-auto px-6 py-3">
          ...
          <Link href="/" className="flex-shrink-0">
            <svg width="103" height="24" viewBox="0 0 102.857 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M 53.225 6.894 L 53.225 5.169 C 53.225 4.42 53.838 3.808 54.587 3.808 L 56.977 3.808 L 56.977 0.536 L 54.535 0.536 C 51.926 0.536 49.793 2.67 49.793 5.278 L 49.793 6.894 L 48.585 6.894 L 47.377 6.894 L 47.377 10.199 L 49.793 10.199 L 49.793 22.788 L 53.227 22.788 L 53.227 10.199 L 56.978 10.199 L 56.978 6.894 Z" fill="#635BFF"/>
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link
              href="/#about"
              className={` text-[15px] leading-[2em] text-center no-underline transition-opacity duration-200 hover:opacity-80 text-black`}
            >
              About
            </Link>
            <Link
