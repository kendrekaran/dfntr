      ...
      <div className=" mx-auto bg-gradient-to-b px-[32px] py-[40px] border-[1px] border-[#0000001A] from-[#635BFF50] to-[#635BFF00] rounded-[24px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-12">
          ...
          <div className="flex flex-col gap-6 max-w-md">
            ...
            <svg width="138" height="32" viewBox="0 0 102.857 24" fill="635BFF" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              ...
              <p className="text-gray-600 text-[16px] max-w-[300px]">
          ...
          <div className="flex gap-[132px]">
            ...
            <div className="flex flex-col gap-6">
                ...
                <a
                    ...
                    className="flex items-center font-medium gap-2 text-indigo-600 hover:text-indigo-700 transition-colors duration-200"
                >
        ...
        {/* Copyright */}
        <div className="text-[#00000080] text-[16px] font-medium text-center md:text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-[40px]">
            ...
            <a
            href="#"
            className="text-[#3B3B3B] font-medium hover:text-indigo-600 transition-colors duration-200"
            >
            Terms & Conditions
            </a>
